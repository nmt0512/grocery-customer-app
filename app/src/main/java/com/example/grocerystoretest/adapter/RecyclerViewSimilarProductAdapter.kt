...
class RecyclerViewSimilarProductAdapter(private val productResponseList: List<ProductResponse>) :
    RecyclerView.Adapter<RecyclerViewSimilarProductAdapter.SimilarProductViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): RecyclerViewSimilarProductAdapter.SimilarProductViewHolder {
    ...
    override fun onBindViewHolder(
        holder: RecyclerViewSimilarProductAdapter.SimilarProductViewHolder,
        position: Int
    ) {
        holder.bind(productResponseList[position])
    }

    inner class SimilarProductViewHolder(val binding: ItemHomeProductBinding) :
